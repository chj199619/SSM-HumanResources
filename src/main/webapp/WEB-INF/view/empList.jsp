...
<div class="modal-body">
    ...
    <div class="form-group row">
        <div class="col-xs-3">
            <label for="searchename" >员工姓名:</label>
...
<div class="modal-body">
    <a class="btn btn-default" href="#" role="button"  id="addEmp" name="addEmp" style="color: #00aa88">新增</a>
</div>
<div class="modal-body">
    <table class="table table-hover table-bordered">
        ...
        <c:forEach begin="0" end="${empList.size()}" items="${empList}" var="emp" step="1">
            <tr>
                ...
                <td>${emp.comm}</td>
                <td>${emp.deptno}</td>
                <td><a class="deleteEmp"><span class=" glyphicon glyphicon-trash "  style="float:left; font-size: large" ><i class="icon-th" ></i></span></a></td>
                    <%--<td><a >修改</a></td>--%>
                <td><a class="updateEmp" ><span class=" glyphicon glyphicon-pencil "  style="float:left; font-size: large" ><i class="icon-th" ></i></span></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
